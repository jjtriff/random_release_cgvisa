...
class CRestClient {
     ...
     *
     */
    public function addEvent($p_sAgendaID,
     $p_sServiceID,
     $p_dStartDate,
     $p_dEndDate,
     $p_iStartTime,
     ...
     *
     */
    public function addSocialEvent($p_sPublicCenterApiKey,
                                 $p_sEmail,
                                 $p_sAgendaID,
                                 $p_sServiceID,
                                 $p_dStartDate,
        ...
        $sMethod="post";
        $sResult = $this->startConnection($sUrl,
                                     $p_sMode, $p_bSecure, $sMethod, $somePostParams);
        return $sResult;
    }
    ...
    *
    */
    public function updateClient($p_sClientId,$p_sMode, $p_bSecure, 
            $p_bWebaccess=null, $p_sPassword="", $p_sEmail="", $p_sCellphone="", $p_sInternationalCode="", $p_sDocument="", 
            $p_sName = "", $p_sAddress = "", $p_sPhone = "", $p_sBlocked = "", $p_someCustomFields=array()){
     ...
     *
     */
    public function deleteEvent($p_sMode, $p_bSecure, $p_sEventID, $p_sEventSynchroID = "", $p_bSendNotification = false, $p_sDeletedBy = "API"){
        $somePostParams = array(
    ...
    */
     ...
     *
     */
    public function updateEvent($p_sMode,
     $p_bSecure,
     $p_sEventID,
     $p_sAgendaID,
     $p_sServiceID,
    ...
    */
     ...
     *
     */
    public function getEvents($p_sDateFrom, $p_sDateTo, $p_sMode, $p_bSecure, $p_sAgendaID = null){
